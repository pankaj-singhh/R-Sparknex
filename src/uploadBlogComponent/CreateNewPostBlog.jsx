...
const CreateNewPostBlog = () => {
  ...
  return (
    ...
    <div className=" bg-white rounded-2xl mt-3 w-[70vw] ml-[3.5rem]">
      <input type="text" placeholder='Add Title'className='w-[70vw] pt-3 pb-3 pl-5  rounded-2xl' />
    </div>
    <div className="flex flex-col md:flex-row">
      <div>
        ...
        <input className="text-lg text-gray-600 w-[75vw] md:w-[40vw]  ml-[3.5rem] rounded-2xl pl-3 pt-2 pb-2 pr-3 mt-3 bg-white "
        placeholder='Add tags (just add # in starting of the tag and separate using commas)'/>
...
export default CreateNewPostBlog